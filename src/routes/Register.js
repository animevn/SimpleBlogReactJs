    ...
    <Grid container direction="row" justify="center">
      ...
      <Box component="form" onSubmit={handleRegister}
        ...
        <Box display="flex" flexDirection="row" justifyContent="space-between" alignItems="center"
             ...
             width={0.6} mt={5} bgcolor="primary.main" borderColor="secondary.main">
        ...
        <Box display="flex" flexDirection="row" justifyContent="space-between" alignItems="center"
             border={1} borderRadius={5} pl={1} overflow="hidden" height={45} boxShadow={3}
             width={0.6} mt={2} bgcolor="primary.main" borderColor="secondary.main">
          <Box width={0.35} color="secondary.main">
            Password
          </Box>
        ...
        <Box display="flex" flexDirection="row" justifyContent="center" alignItems="stretch"
             ...
             width={0.6} mt={1} boxShadow={3} borderColor="secondary.main" >
          <Button variant="text" size="large" fullWidth type="submit">
            <Box color="secondary.main">Register</Box>
          </Button>
